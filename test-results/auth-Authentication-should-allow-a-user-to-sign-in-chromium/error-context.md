...
- Name: auth.spec.ts >> Authentication >> should allow a user to sign in
- Location: playwright/tests/auth.spec.ts:4:7
...
```yaml
- generic [ref=e2]: "{\"message\":\"Cannot GET /auth/signin\",\"error\":\"Not Found\",\"statusCode\":404,\"timestamp\":\"2026-06-10T10:43:40.403Z\",\"path\":\"/auth/signin\"}"
```
